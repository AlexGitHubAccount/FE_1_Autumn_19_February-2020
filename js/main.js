...
MainObject.prototype.begin = function () { //Write a prototype for our future object MainObject
    this.polyfill();
    new SearchField();
    new Gamburger();
...
//Write a prototype for my localstorage
...
//Write a prototype for properties matches and closest
...
function CatalogBanner (offer) {//Main constructor for our text on the catalog.page
    if (!offer) return;
    this.offer = offer;
